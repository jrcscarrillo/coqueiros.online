...
<html>
    <head>
        ...
        <link rel="stylesheet" href="https://carrillosteam.com/public/css/sky-forms-coqueiros.css">
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-6 paddingtop-bottom">
                    ...
                    <ul class="footer-ul">
                        ...
                        <li><?= $this->tag->linkTo(['about/index', 'Nosostros']) ?></li>
                        <li><a href="#">Blog</a></li>
    ...
    <?= $this->tag->javascriptInclude('/public/js/jquery.form.min.js') ?>
    <?= $this->tag->javascriptInclude('/public/js/jquery.maskedinput.min.js') ?>
    <?= $this->tag->javascriptInclude('/public/js/jquery.modal.js') ?>
    <?= $this->tag->javascriptInclude('/public/js/jquery.validate.min.js') ?>
    <?= $this->tag->javascriptInclude('/public/js/utils.js') ?>
    <!--[if lt IE 10]>
