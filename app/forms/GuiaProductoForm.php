...
class GuiaProductoForm extends Form {
    ...
    public function initialize() {
        ...
        $numeroLote = new Text("numeroLote");
        $numeroLote->setLabel("Lotes");
        $numeroLote->addValidators(array(
           new PresenceOf(array(
              'message' => 'Debe ingresar lotes separados con ;'
              ))
        ));
        $this->add($numeroLote);
