<div class="row">
    <nav>
        <ul class="pager">
            <li class="previous">{{ link_to("creditmemolinedetail", "Go Back") }}</li>
        </ul>
    </nav>
</div>
...
<div class="page-header">
    <h1>
        Create creditmemolinedetail
    </h1>
</div>

{{ content() }}

{{ form("creditmemolinedetail/create", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
