<div class="page-header">
    <h1>
        Search creditmemolinedetail
    </h1>
    <p>
        {{ link_to("creditmemolinedetail/new", "Create creditmemolinedetail") }}
    </p>
</div>

{{ content() }}

{{ form("creditmemolinedetail/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
