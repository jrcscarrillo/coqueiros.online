<div class="row">
    <nav>
        <ul class="pager">
            <li class="previous">{{ link_to("salesorder", "Go Back") }}</li>
        </ul>
    </nav>
</div>
...
{{ form("salesorder/create", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
...
<div class="form-group">
    <label for="fieldTotalamountinhomecurrency" class="col-sm-2 control-label">TotalAmountInHomeCurrency</label>
    <div class="col-sm-10">
        {{ text_field("TotalAmountInHomeCurrency", "type" : "numeric", "class" : "form-control", "id" : "fieldTotalamountinhomecurrency") }}
    </div>
</div>
...
<div class="form-group">
    <label for="fieldLinkedtxn" class="col-sm-2 control-label">LinkedTxn</label>
    <div class="col-sm-10">
        {{ text_field("LinkedTxn", "size" : 30, "class" : "form-control", "id" : "fieldLinkedtxn") }}
    </div>
</div>
