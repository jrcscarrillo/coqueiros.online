...
{% block cabecera %}
    <div class="bg-blue">
        {{ form("guiacab/create", "class" : "sky-form", "id":"solid-form") }}
    {% endblock %}
    {% block cuerpoforma %}
        <fieldset>
            <section>
                    ...
                    <div class="col col-4">
                        <div class="form-group">
                            ...
                            <div class="input textarea-expandable">
                                {{ form.render('motive', ['class': 'form-element form-element-icon', 'rows':'4', 'cols':'40', 'id':'motive', 'name':'motive', 'placeholder':'Digitar al menos n/a' ]) }}
                            </div>
                        </div>
                    </div>
                </div>
