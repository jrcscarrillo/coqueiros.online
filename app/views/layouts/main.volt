...
<html>
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-6 paddingtop-bottom">
                    ...
                    <ul class="footer-ul">
                        ...
                        <li>{{ link_to("about/index", "Nosostros") }}</li>
                        <li><a href="#">Blog</a></li>
    ...
    {{ javascript_include("/public/js/jquery.form.min.js") }}
    {{ javascript_include("/public/js/jquery.maskedinput.min.js") }}
    {{ javascript_include("/public/js/jquery.modal.js") }}
    {{ javascript_include("/public/js/jquery.validate.min.js") }}
