...
{% block forma %}
    {{ content() }}
    <div align="left">
        {{ link_to("appliedtosync", "&larr; Go Back") }}
    </div>
    <div align="right">
    ...
    {% endblock %}
    {% block cabecera %}
        {{ form("appliedtosync/save", 'role': 'form', 'class':'sky-form')}}
    {% endblock %}
    {% block cuerpoforma %}
        <fieldset>
        ...
        <footer>
            ...
            <p class="help-block">Puede buscar una ocurrencia de fechas utilizadas o varias.</p>
        </footer>
    </form>
</div>
{% endblock %}