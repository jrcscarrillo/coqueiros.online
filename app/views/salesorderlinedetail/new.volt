<div class="row">
    <nav>
        <ul class="pager">
            <li class="previous">{{ link_to("salesorderlinedetail", "Go Back") }}</li>
        </ul>
    </nav>
</div>
...
<div class="page-header">
    <h1>
        Create salesorderlinedetail
    </h1>
</div>

{{ content() }}

{{ form("salesorderlinedetail/create", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
