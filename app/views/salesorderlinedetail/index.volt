<div class="page-header">
    <h1>
        Search salesorderlinedetail
    </h1>
    <p>
        {{ link_to("salesorderlinedetail/new", "Create salesorderlinedetail") }}
    </p>
</div>

{{ content() }}

{{ form("salesorderlinedetail/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
