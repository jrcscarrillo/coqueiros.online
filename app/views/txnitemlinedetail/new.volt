<div class="row">
    <nav>
        <ul class="pager">
            <li class="previous">{{ link_to("txnitemlinedetail", "Go Back") }}</li>
        </ul>
    </nav>
</div>
...
<div class="page-header">
    <h1>
        Create txnitemlinedetail
    </h1>
</div>

{{ content() }}

{{ form("txnitemlinedetail/create", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
...
<div class="form-group">
    <label for="fieldCost" class="col-sm-2 control-label">Cost</label>
    <div class="col-sm-10">
        {{ text_field("Cost", "size" : 30, "class" : "form-control", "id" : "fieldCost") }}
    </div>
</div>
...
<div class="form-group">
    <label for="fieldBillablestatus" class="col-sm-2 control-label">BillableStatus</label>
    <div class="col-sm-10">
        {{ text_field("BillableStatus", "size" : 30, "class" : "form-control", "id" : "fieldBillablestatus") }}
    </div>
</div>
