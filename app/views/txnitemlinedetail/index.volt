<div class="page-header">
    <h1>
        Search txnitemlinedetail
    </h1>
    <p>
        {{ link_to("txnitemlinedetail/new", "Create txnitemlinedetail") }}
    </p>
</div>

{{ content() }}

{{ form("txnitemlinedetail/search", "method":"post", "autocomplete" : "off", "class" : "form-horizontal") }}
